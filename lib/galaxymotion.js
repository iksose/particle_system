...
Galaxy.CameraMotions.prototype = {
  ...
  reset: function(callback) {
    ...
    TweenMax.to(upCurrent, duration / 1.5, {
      x: upGoal.x,
      y: upGoal.y,
      z: upGoal.z
    });
    ...
    TweenMax.to(positionCurrent, duration, {
      x: home.x,
      y: home.y,
      z: home.z,
  ...
  zoomToFitPointsFrom: function(pointList, cameraRelation, callback) {
    ...
    TweenMax.to(cameraTargetCurrent, duration / 1.5, {
      x: cameraTargetEnd.x,
      y: cameraTargetEnd.y,
      z: cameraTargetEnd.z
    });
    ...
    TweenMax.to(currentCameraPosition, duration, {
  ...
  showThreePointsNicely: function(pointList, callback) {
    ...
    TweenMax.to(that.target, duration / 1.5, {
      x: pointZeroClone.x,
      y: pointZeroClone.y,
      z: pointZeroClone.z
    });
  ...
  cameraSetupForParameter: function(cameraParameter, loopConstants) {
    var pos, lookAt = loopConstants.targetLoopStart.clone(),
      up = loopConstants.upLoopStart.clone();
